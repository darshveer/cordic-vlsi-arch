...
#
# Script generated by Vivado on Mon Apr 27 21:42:38 +0530 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : top_cordic.sh
...
#
# Usage        : top_cordic.sh
#                top_cordic.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_cordic.sh [-reset_run]
#                top_cordic.sh [-reset_log]
#                top_cordic.sh [-help]
#
...
# script info
echo -e "top_cordic.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_cordic.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot top_cordic xil_defaultlib.top_cordic xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_cordic -key {Behavioral:sim_1:Functional:top_cordic} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_cordic.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./top_cordic.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: top_cordic.sh [-help]\n\
Usage: top_cordic.sh [-step]\n\
Usage: top_cordic.sh [-lib_map_path]\n\
Usage: top_cordic.sh [-reset_run]\n\
Usage: top_cordic.sh [-reset_log]\n\
Usage: top_cordic.sh [-keep_index]\n\
Usage: top_cordic.sh [-noclean_files]\n\n\
